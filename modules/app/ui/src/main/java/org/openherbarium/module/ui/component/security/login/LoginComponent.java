...
public class LoginComponent extends Composite implements HasLogger {
  ...
  public static final String ID_BUTTON_OK =
      buttonID().apply(LoginComponent.class, BUTTON_CAPTION_OK);
  public static final String ID_BUTTON_CANCEL =
      buttonID().apply(LoginComponent.class, BUTTON_CAPTION_CANCEL);
  public static final String ID_TEXTFIELD_LOGIN =
      textfieldID().apply(LoginComponent.class, TEXTFIELD_CAPTION_LOGIN);
  public static final String ID_PASSWORDFIELD_PASSWORD =
      passwordID().apply(LoginComponent.class, PASSWORDFIELD_CAPTION_PASSWORD);
  public static final String ID_PANEL_MAIN =
      passwordID().apply(LoginComponent.class, PANEL_CAPTION_MAIN);
  ...
  public void postProcess() {
    ...
    ok.addClickListener((Button.ClickListener) event -> {
      ...
      if (loginService.checkLogin(loginValue, passwordValue)) {
        ...
        userService.loadUser(loginValue).ifPresentOrElse((u) -> {
        ...
        show(property("login.failed"), property("login.failed.description"),
